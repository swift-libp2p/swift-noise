...
final class noiseTests: XCTestCase {
    ...
    let initiatorsStatic = try! Curve25519.KeyAgreement.PrivateKey(rawRepresentation:
        Array(hex: "000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f"))

    let respondersStatic = try! Curve25519.KeyAgreement.PrivateKey(rawRepresentation:
        Array(hex: "0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20"))

    let initiatorsEphemeral = try! Curve25519.KeyAgreement.PrivateKey(rawRepresentation:
        Array(hex: "202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f"))

    let respondersEphemeral = try! Curve25519.KeyAgreement.PrivateKey(rawRepresentation:
    ...
    func testHMACChaining() throws {
        ...
        let chainingKey = sharedSecret.hkdfDerivedSymmetricKey(using: SHA256.self, salt: protocolSalt, sharedInfo: Data(), outputByteCount: 32)
...
//    }
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA256() throws {
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d484663414af878d3e46a2f58911a816d6e8346d4ea17a6f2a0bb4ef4ed56c133cff4560a34e36ea82109f26cf2e5a5caf992b608d55c747f615e5a3425a7a19eefb8f")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "87f864c11ba449f46a0a4f4e2eacbb7b0457784f4fca1937f572c93603e9c4d97e5ea11b16f3968710b23a3be3202dc1b5e1ce3c963347491e74f5c0768a9b42")
        ...
        let message1 = Array<UInt8>("yellowsubmarine".data(using: .utf8)!)
        ...
        let message2 = Array<UInt8>("submarineyellow".data(using: .utf8)!)
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA256_With_Payloads() throws {
        ...
        print( msgInit1.toHexString )
        XCTAssertEqual(msgInit1.toHexString(), "358072d6365880d1aeea329adf9121383851ed21a28e3b75e965d0d2cd166254746573745f6d73675f30")
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d484663414af878d3e46a2f58911a816d6e8346d4ea17a6f2a0bb4ef4ed56c133cff4572e7a2ba5123ac30618b3d205f5c2d17f50cbca216483ac56bcc78e33bf520303278db641e5e731b2e3a")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "87f864c11ba449f46a0a4f4e2eacbb7b0457784f4fca1937f572c93603e9c4d9f27e318e43ba630594c4d08eeb3b36d97c7377a2f4f9144b2f0c8095ad92140505b2ab53eff244b14138")
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA256_With_Prologue() throws {
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d484663414af878d3e46a2f58911a816d6e8346d4ea17a6f2a0bb4ef4ed56c133cff4588f043d1e49a3289b1beeab8f96b0551a48cddf9f38b1a12e46c6908644198f3")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "87f864c11ba449f46a0a4f4e2eacbb7b0457784f4fca1937f572c93603e9c4d95a04fa1f1c41fb3f00d496f242c1e44ce5b749b3d54bf74cea2dad086d601fb6")
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA256_With_Payload_and_Prologue() throws {
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d484663414af878d3e46a2f58911a816d6e8346d4ea17a6f2a0bb4ef4ed56c133cff4545958c588d17d6373e0c1dcfa3755d37f50cbca216483ac56bcc98f5095870aa814ba40c08079c11f087")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "87f864c11ba449f46a0a4f4e2eacbb7b0457784f4fca1937f572c93603e9c4d9c1e9a1a313d02b78871cfd178a521a4c7c7377a2f4f9144b2f0ccedc84d379151b466741e4b266db6023")
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA256_PreSharedKey0() throws {
        ...
        let initiator = try Noise.HandshakeState(config:
            Noise.Config(
                ...
                initiator: true,
                prologue: [],
                presharedKey: (key: Array(hex: "2176657279736563726574766572797365637265747665727973656372657421"), placement: 0),
                staticKeypair: initiatorsStatic,
                ephemeralKeypair: initiatorsEphemeral
            )
        )
        ...
        print( msgInit1.toHexString )
        XCTAssertEqual(msgInit1.toHexString(), "358072d6365880d1aeea329adf9121383851ed21a28e3b75e965d0d2cd166254555f63b2499511e3b299a5649351a5b7")
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d4846622df46c0ac1e0fc71795a84e37cc0e963d131c8e84c02cd5cfcfe8def3fe128b324ab54fd3be59ac143dfdc68996211170078c960e051d6ed971da20bde0fcf1")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "462127adbe047db3d1fce0581b5447d99b606c591545a7719132e0c91fe93d123be3fe89ffd8af56e02cefda863080ecee5651dcecddde76b8237c66740d7c8f")
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA256_PreSharedKey1() throws {
        ...
        let initiator = try Noise.HandshakeState(config:
            Noise.Config(
                ...
                initiator: true,
                prologue: [],
                presharedKey: (key: Array(hex: "2176657279736563726574766572797365637265747665727973656372657421"), placement: 1),
                staticKeypair: initiatorsStatic,
                ephemeralKeypair: initiatorsEphemeral
            )
        )
        ...
        print( msgInit1.toHexString )
        XCTAssertEqual(msgInit1.toHexString(), "358072d6365880d1aeea329adf9121383851ed21a28e3b75e965d0d2cd1662549f27cade2b6f2db14f582e49cfbfc068")
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d484667f0f30704cd806d42849595f4e39d8ace7b1f7ab9c62c9ccaf7284b3d8ce0d88286de6a5c75efd3ada339fd7ba335dee5fe0151a61f7decdabe8fab42d807358")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "3709db3d2b87c711bdd3ef87e62edd8a2775482a4421a58fb5eeb106861e98d24c021634f68b6fa8a9c2f48161e190714c2a2d90a55d2dc32f33fcbaf5afc67c")
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA256_PreSharedKey2() throws {
        ...
        let initiator = try Noise.HandshakeState(config:
            Noise.Config(
                ...
                initiator: true,
                prologue: [],
                presharedKey: (key: Array(hex: "2176657279736563726574766572797365637265747665727973656372657421"), placement: 2),
                staticKeypair: initiatorsStatic,
                ephemeralKeypair: initiatorsEphemeral
            )
        )
        ...
        print( msgInit1.toHexString )
        XCTAssertEqual(msgInit1.toHexString(), "358072d6365880d1aeea329adf9121383851ed21a28e3b75e965d0d2cd16625462f2d89ffb750657573d23edc7c79728")
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d48466c9996f0e38eded0281a0f505a4f2473b114924724e374c408b3ba103abc7ffbf72bf9b5f5f37f1a8ee33e4708c1f35d54d93fc2a553004be11b9a6ad56d03f30")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "4744625f46dfce9240a5b1927393fd862a2520366f4df66de4b75019d201de92f3bd1d11aef54b65374c268c0ec19d34ec1fff795f07ef7065932e5983ee2e84")
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA256_PreSharedKey3() throws {
        ...
        let initiator = try Noise.HandshakeState(config:
            Noise.Config(
                ...
                initiator: true,
                prologue: [],
                presharedKey: (key: Array(hex: "2176657279736563726574766572797365637265747665727973656372657421"), placement: 3),
                staticKeypair: initiatorsStatic,
                ephemeralKeypair: initiatorsEphemeral
            )
        )
        ...
        print( msgInit1.toHexString )
        XCTAssertEqual(msgInit1.toHexString(), "358072d6365880d1aeea329adf9121383851ed21a28e3b75e965d0d2cd166254648d756cb03de7ad06e87f9a577c00de")
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d4846696a7a5454cc70bb4eec2a2f7c616c143564ff1ae149458f9e70afb3498be7a88c9feda8ece3bb7d846bd57a37fc9cf362b7d090998d862bd82fcf9a19cf154e1")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "f5b6224ea13577089dc14b20ca8e90d0cedede4faff50348d4d0a0f941182ad787d1e72132665f8402f660af90e07e671606bb5a4931d244dfa6590809fac237")
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA256_PreSharedKey4() throws {
        ...
        XCTAssertThrowsError( try Noise.HandshakeState(config:
            Noise.Config(
                cipherSuite: Noise.CipherSuite(
                    keyCurve: .ed25519,
                    cipher: .ChaChaPoly1305,
                ...
                initiator: true,
                prologue: [],
                presharedKey: (key: Array(hex: "2176657279736563726574766572797365637265747665727973656372657421"), placement: 4),
                staticKeypair: initiatorsStatic,
                ephemeralKeypair: initiatorsEphemeral
            )
        ) )
    ...
    func testNoise_XX_25519_ChaChaPoly_SHA512() throws {
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d4846692e5b8dda95b4ec55e42c2cbded11735474b3612a895298bcb02e8469353fe827273e4a7aadfc1aa32578b46bce2006fe1482f062e2f27e43ad23e67a304c030")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "ac3087e2342498dfa6606faf700dc5782b9612bdbc8bbb67a87181baac2d693d2f8df70600534bcbd389bbbf733550ae3e7e9a78f80aafa70d6211640223800d")
    ...
    func testNoise_XX_25519_AESGCM_SHA256() throws {
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d484665393019dbd6f438795da206db0886610b26108e424142c2e9b5fd1f7ea70cde8767ce62d7e3c0e9bcefe4ab872c0505b9e824df091b74ffe10a2b32809cab21f")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "e610eadc4b00c17708bf223f29a66f02342fbedf6c0044736544b9271821ae40e70144cecd9d265dffdc5bb8e051c3f83db32a425e04d8f510c58a43325fbc56")
    ...
    func testNoise_XX_25519_AESGCM_SHA512() throws {
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d48466881a9849f98286c79700c48c40e6667ce14ce8baabdf27b51fb80d248c2d56a65be777dc2ad2438d794410a91e1542a138b33b73a5ff808ecff2e90952defca9")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "a0c7c991f077df03c26762bb80c9dc4c830c71a012dc1a002363a684c659a3487c8a7c790075c7a5ac8de6fe1ccc7363d39bea6035a91323f511f662ee40d9de")
    ...
    func testNoise_NN_25519_AESGCM_SHA256() throws {
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d484667cc0d7b4540fd183ba30ecbd3f464f16")
    ...
    func testNoise_KN_25519_AESGCM_SHA256() throws {
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d48466827d5016baa63241017945dea7aeb9be")
    ...
    func testNoise_XK_25519_ChaChaPoly_SHA256() throws {
        ...
        print( msgInit1.toHexString )
        XCTAssertEqual(msgInit1.toHexString(), "358072d6365880d1aeea329adf9121383851ed21a28e3b75e965d0d2cd1662549963aa4003cb0f60f51f7f8b1c0e6a9c")
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d4846630166c893dafe95f71d102a8ac640a52")
        ...
        XCTAssertEqual(msgInit3.toHexString(), "24a819b832ab7a11dd1464c2baf72f2c49e0665757911662ab11495a5fd4437e0abe01f5c07176e776e02716c4cb98a005ec4c884c4dc7500d2d9b99e9670ab3")
    ...
    func testNoise_IX_25519_ChaChaPoly_SHA256_PresharedKey1() throws {
        ...
        print( msgInit1.toHexString )
        XCTAssertEqual(msgInit1.toHexString(), "358072d6365880d1aeea329adf9121383851ed21a28e3b75e965d0d2cd1662545667d83bcfa7dbb6ee159dde3afffea915ce4084462fc02f7f7dc86c2d338a98e01aeac3a330e93ed7024c2417abe12b8b941d28126267f9ec338fb268badb92")
        ...
        XCTAssertEqual(msgResp2.toHexString(), "64b101b1d0be5a8704bd078f9895001fc03e8e9f9522f188dd128d9846d48466f04c5f04c9ae8992c210cb0193a52ae8c081c44f33ab1490df3e3c344eb1457c60a8f15129cf89e14206666494b093758fbe507fcae17bee288b08f9c85ee4eb")
    ...
    func testXHandshakeWithEnum() throws {
        ...
        print( msgInit1.toHexString )
        XCTAssertEqual(msgInit1.toHexString(), "358072d6365880d1aeea329adf9121383851ed21a28e3b75e965d0d2cd16625464d0a2b152420f100932269d5d383be29d5262c4287efbfc1a4689f88752b5e86e5ef46c6d25996ebdb230b7431be817ef2c2f22b87d9c53accd25f4ff987e5fab341d7f7fb4079e5c4b")
...
struct NoiseTestSuite {
    static let initiatorsStatic = try! Curve25519.KeyAgreement.PrivateKey(rawRepresentation:
        Array(hex: "000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f"))

    static let respondersStatic = try! Curve25519.KeyAgreement.PrivateKey(rawRepresentation:
        Array(hex: "0102030405060708090a0b0c0d0e0f101112131415161718191a1b1c1d1e1f20"))

    static let initiatorsEphemeral = try! Curve25519.KeyAgreement.PrivateKey(rawRepresentation:
        Array(hex: "202122232425262728292a2b2c2d2e2f303132333435363738393a3b3c3d3e3f"))

    static let respondersEphemeral = try! Curve25519.KeyAgreement.PrivateKey(rawRepresentation:
        Array(hex: "4142434445464748494a4b4c4d4e4f505152535455565758595a5b5c5d5e5f60"))
    ...
    internal static func doHandshakeVector(_ str:String, index i:Int) throws -> Bool {
        ...
        print("Running Test Vector \(i) -> \(handshake)\(prologue.count > 0 ? " - Prologue" : "")\(payloads.count > 0 ? " - Payloads" : "")")
        //print(payloads)
        
        let usesInitiatorsStaticKey = str.contains("init_static=")
        let usesRespondersStaticKey = str.contains("resp_static=")
        
        let result = try NoiseTestSuite.doArbitraryHandshakeVectorTextOutput(String(handshake), usesInitStatic: usesInitiatorsStaticKey, usesRespStatic: usesRespondersStaticKey, prologue: prologue, payloads: payloads)
    ...
    internal static func doArbitraryHandshakeVectorTextOutput(_ str:String, usesInitStatic:Bool, usesRespStatic:Bool, prologue:[UInt8], payloads:[Int:String] = [:]) throws -> [String] {
        var messageLog:[String] = []
        
        let initiator = try createInitiator(str, initStatic: usesInitStatic, respStatic: usesRespStatic, prologue: prologue, messageLog: &messageLog)
    ...
    internal static func createInitiator(_ str:String, initStatic:Bool, respStatic:Bool, prologue:[UInt8], messageLog:inout [String]) throws -> Noise.HandshakeState {
...
//        }
    ...
    internal static func createResponder(_ str:String, respStatic:Bool, prologue:[UInt8]) throws -> Noise.HandshakeState {
        guard let cs = cipherSuiteFromString(str) else { throw Errors.unableToExtractCipherSuiteFromString }
        guard let hs = handshakeFromString(str) else { throw Errors.unableToExtractHandshakeFromString }
